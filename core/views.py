...
class APIRoot(APIView):
    ...
    equivalent to the page_size in other styles.
    The offset indicates the starting position of the query in relation to
    the complete set of unpaginated items.

    - ####Example:
        *  #####Paginated motels list with 10 results per page:
        [/api/motels/?limit=10](/api/motels/?limit=10)
